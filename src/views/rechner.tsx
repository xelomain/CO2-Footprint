...
//Rechner ist eine Funktion wird aber durch das const zu einer Anonymefunktion
const Rechner: React.FunctionComponent = () => {
  var co2Wert = 0;

  //hier werden alle Variablen in sogenanten States deklariert.
  //mit der ersten stelle kann man die Variable aufrufen und mit der zweiten ändern.
  ...
  co2Wert =
    co2Wert +
    grundnahrungsmittelWert +
    kleingereate +
    entsorungsnetz +
    konsumgueter +
    haeuserbau +
    offentlicheDienstleistung;
  ...
  return (
    <>
      <div>
        <h1>CO2 Fußabdruckrechner</h1>
      </div>

      <div
        className="row"
        style={{ display: "block", width: 700, padding: 20 }}
      >
        <FormControl>
          ...
          >
            ...
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="Etwa ein Viertel"
            />
            <FormControlLabel
              value="3"
              control={<Radio />}
              label="Etwa die Haelfte"
            />
            <FormControlLabel
              value="4"
              control={<Radio />}
              label="Etwa drei Viertel"
            />
            <FormControlLabel
              value="5"
              control={<Radio />}
              label="Komplett saisonal"
            />
          </RadioGroup>
        </FormControl>
      </div>
        ...
        <FormControl>
          ...
          >
            ...
            <FormControlLabel
              value="3"
              control={<Radio />}
              label="3-6x pro Woche"
            />
            <FormControlLabel
              value="4"
              control={<Radio />}
              label="1-3x pro Woche"
            />
            <FormControlLabel
              value="5"
              control={<Radio />}
      ...
      >
        <p>
          Durch den Verbrauch der Grundnahrungsmittel wird ein Wert von 0,77
        ...
        <FormControl>
          ...
          >
            ...
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="14.000 - 30.000 km"
            />
            <FormControlLabel
              value="3"
              control={<Radio />}
              label="9.000 - 14.000 km"
            />
            <FormControlLabel
              value="4"
              control={<Radio />}
              label="2.000 - 9.000 km"
            />
      ...
      >
        <FormControl>
          <FormLabel>
            Wie oft fahren Sie mit öffentlichen Verkehrsmitteln?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
      ...
      >
        <FormControl>
          <FormLabel>
            Wie oft sind Sie in den letzten 5 Jahren privat geflogen?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
      ...
      >
        <FormControl>
          <FormLabel>
            Wie viele Stunden waren Sie in den letzten 5 Jahren auf Kreuzfahrt?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
        ...
        <FormControl>
          ...
          >
            <FormControlLabel
              value="1"
              control={<Radio />}
              label="Bis 1994 (unsaniert)"
            />
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="1995  bis 2001 (unsaniert)"
            />
            <FormControlLabel value="3" control={<Radio />} label="Ab 2001" />
            <FormControlLabel
              value="4"
              control={<Radio />}
              label="Energetisch vollsaniert (Baujahr bis 1948)"
            />
            <FormControlLabel
              value="5"
              control={<Radio />}
              label="Energetisch vollsaniert (Baujahr 1949 bis 2001)"
            />
            <FormControlLabel
              value="6"
              control={<Radio />}
      ...
      >
        <FormControl>
          <FormLabel>
            Welche Effizienzklasse haben Ihre Haushaltsgeräte?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
        ...
        <FormControl>
          ...
          >
            <FormControlLabel
              value="1"
              control={<Radio />}
              label="Mehrere Kühlschränke und/oder Tiefkühltruhen"
            />
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="Kühlgefrierkombi (zweitürig) oder Kühlschrank mit kleinem Gefrierfach in Kombination mit Tiefkühler"
            />
            <FormControlLabel
              value="3"
              control={<Radio />}
              label="Ein Kühlschrank mit kleinem Gefrierfach"
            />
          </RadioGroup>
        </FormControl>
      </div>
        ...
        <FormControl>
          ...
          >
            <FormControlLabel
              value="1"
              control={<Radio />}
              label="Jede Wäsche auf der maximal vorgesehenen Waschtemperatur und manchmal auch Kochwäsche (95°C)"
            />
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="Den Großteil der Wäsche bei 40°C, etwa ein Drittel bei 60°C, keine Kochwäsche (95°C)"
            />
            <FormControlLabel
              value="3"
              control={<Radio />}
              label="Mehr als die Hälfte der Wäsche bei 30°C und weniger, nur ganz selten 60°C"
            />
          </RadioGroup>
        </FormControl>
      </div>
        ...
        <FormControl>
          ...
          >
            <FormControlLabel
              value="1"
              control={<Radio />}
              label="Nur im Wäschetrockner oder Raum mit Lufttrockner"
            />
            <FormControlLabel
              value="2"
              control={<Radio />}
              label="Teils mit Wäschetrockner/Lufttrockner, teils an der Wäscheleine"
            />
            <FormControlLabel
              value="3"
              control={<Radio />}
              label="An der Wäscheleine"
            />
          </RadioGroup>
        </FormControl>
      </div>
      ...
      >
        <FormControl>
          <FormLabel>
            Wie viel geben Sie monatlich für Kleider und Schuhe aus?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
      ...
      >
        <FormControl>
          <FormLabel>
            Wie viel geben Sie monatlich für Freizeit und Kultur aus?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
      ...
      >
        <FormControl>
          <FormLabel>
            Wie viel geben Sie monatlich für Möbel und Haushaltsgeräte aus?
          </FormLabel>
          <RadioGroup
            aria-labelledby="demo-radio-buttons-group-label"
            defaultValue={1}
      ...
      >
        ...
        <div className="row" style={{ margin: 10 }}>
          <TextField
            label={"Ihr CO2 Wirt in Differenz zum Durchschnitt in Deutschland"}
            value={divCo2Wert}
            inputProps={{ readOnly: true }}
          />
        </div>
